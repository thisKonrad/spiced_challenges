...
animalStrings.indexOf(5);

// Hint: Besides the array method, check out the string method `startsWith()`.
const firstAnimalStartingWithLetterP = animalStrings.find((animal)=> {if(animal.startsWith('p')=== true){return animal}});
...
const everyAnimalHasMoreThanTwoLetters = animalStrings.every((animal)=> animal.length > 1);
...
console.log(
"hippo ",hippoExists,
"index of 5 is cat ?",catStartingFromIndexFiveExists,
"firstAP ",firstAnimalStartingWithLetterP,
"indexGirf ",indexOfGiraffe,
"abac sort ",animalsSortedAlphabetically,
"animal any Z",anyAnimalEndsWithLetterZ,
"every more 2 ",everyAnimalHasMoreThanTwoLetters,
"sum ",sumOfAllAnimalCharacters);